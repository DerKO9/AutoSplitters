...
state("YookaLaylee64", "OLD"){
	...
	byte Lag : "AkSoundEngine.dll", 0x001A06F8, 0xE0, 0xE70, 0x20, 0x10, 0x20, 0x18, 0x78, 0x68, 0x70, 0x69; //Backup of NEW, may not work, but final 5 offsets could be the same.
}
