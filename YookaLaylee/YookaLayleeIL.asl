...
state("YLILWin64", "Demo V1"){
	...
	byte beeBreak : "mono.dll", 0x002675E0, 0x40, 0xE30, 0x90;
	byte interactableBook : "mono.dll", 0x002675E0, 0xA0, 0xC28, 0x8, 0x20, 0x30, 0x20, 0x18, 0x78, 0x50, 0x58, 0xA4; //Unconfirmed if working
	byte playerControl : "mono.dll", 0x002675E0, 0xA0, 0xC28, 0x8, 0x20, 0x30, 0x20, 0x18, 0x78, 0x50, 0x58, 0xA6; //Unconfirmed if working
	int owTonics : "UnityPlayer.dll", 0x0144DBD8, 0x8, 0x8, 0x8, 0x2D8, 0x28, 0x18, 0x28; //Unconfirmed if working
	int capBHP : "UnityPlayer.dll", 0x0144DD68, 0x170, 0x10, 0x30, 0x190, 0x1F0, 0x118, 0x78, 0x34; //Unconfirmed if working
	int beeTotal : "mono.dll", 0x002675E0, 0x88, 0x10, 0x1F0, 0x40, 0x8, 0x30, 0x30, 0x20, 0x40, 0x8, 0x30, 0x2C; //Unconfirmed if working
}
